...
import { EngineState, useASCIIEngine } from "@/components/ascii/context";
...
export class Plasma extends Component<PlasmaState> {
    ...
    private nextRequestAnimationFrameId: number | undefined;
    ...
    private startLoop() {
        const tick = () => {
            ...
            this.nextRequestAnimationFrameId = requestAnimationFrame(tick);
        };
        this.nextRequestAnimationFrameId = requestAnimationFrame(tick);
    }

    onUnmount(): void {
        if (this.nextRequestAnimationFrameId)
            cancelAnimationFrame(this.nextRequestAnimationFrameId);
    }
